  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 text-white py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 animate-fade-in">
          ...
          <div className="md:col-span-1">
            <div className="text-2xl font-bold mb-4">
              <span className="text-transparent bg-gradient-to-r from-luxury-gold to-primary-600 bg-clip-text">
                Voyaj
              </span>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              The world's first Agentic Travel Marketplace. We've built a system that doesn't just list flights and hotels—it understands your intent.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-gray-400 hover:text-luxury-gold transition-colors duration-300 hover:scale-110 transform">
          ...
          <div className="animate-slide-up" style={{animationDelay: '0.1s'}}>
            <h3 className="font-semibold text-lg mb-4 text-luxury-gold">Product</h3>
          ...
          <div className="animate-slide-up" style={{animationDelay: '0.2s'}}>
            <h3 className="font-semibold text-lg mb-4 text-luxury-gold">Company</h3>
            <ul className="space-y-3">
          ...
          <div className="animate-slide-up" style={{animationDelay: '0.3s'}}>
            <h3 className="font-semibold text-lg mb-4 text-luxury-gold">Support</h3>
            <ul className="space-y-3">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center animate-fade-in" style={{animationDelay: '0.5s'}}>
          <p className="text-gray-400 text-sm">
            © 2024 Voyaj. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-gray-400 hover:text-luxury-gold text-sm transition-colors duration-300">Terms of Service</a>
            <a href="#" className="text-gray-400 hover:text-luxury-gold text-sm transition-colors duration-300">Privacy Policy</a>
            <a href="#" className="text-gray-400 hover:text-luxury-gold text-sm transition-colors duration-300">Cookie Policy</a>
          </div>
        </div>
      </div>
    </footer>
